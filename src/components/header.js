  ...
  <Navbar bg="light" expand="lg" sticky="top">
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="mr-auto">
        <Nav.Link>
          <Link className="nav-link-new" to="/about">
            About
          </Link>
        </Nav.Link>
        <Nav.Link>
          <Link className="nav-link-new" to="/spiritual">
            Spiritual
          </Link>
        </Nav.Link>
        <Nav.Link>
          <Link className="nav-link-new" to="/banquethalls">
            Banquet Halls
          </Link>
        </Nav.Link>
        <Nav.Link>
          <Link className="nav-link-new" to="/events">
            Events
          </Link>
        </Nav.Link>
